...
'When the game is over the player with most points wins and if 2 players have same points it is' ,'\n'
'therefore a draw. This game has been simplifid to these extents and I made it max two player','\n'
'only when originally was up to 4 players including teams of 2 players. Other points' ,'\n'
'sytems have been excluded from the original version but the game is still functions properly.','\n'
'Enjoy!','\n')
